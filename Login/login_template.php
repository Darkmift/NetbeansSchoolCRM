                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form id="register-form" action="#" method="post" role="form" style="display: none;">
                                ...
                                <div class="form-group">
                                    <input type="email" name="age" id="age" tabindex="1" class="form-control" placeholder="age" value="">
                                </div>         
                                <div class="form-group">
                                    <input type="email" name="address" id="address" tabindex="1" class="form-control" placeholder="address" value="">
                                </div>
                                <div class="form-group">
